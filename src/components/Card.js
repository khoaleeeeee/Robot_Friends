...
const Card = ({ name, email, phone, website, company, id }) => {
  return (
    <Flippy
      flipOnHover={true}
      flipOnClick={false}
    ...
    <BackSide style={{backgroundColor: "lightblue"}}>
      <div>
        ...
        <div className="f6 lh-title mv2">
          <h3>Phone:</h3>
          <p>{phone}</p>
        </div>
        <div className="f6 lh-title mv2 inline">
          <h3>Company:</h3>
          <p>{company}</p>
        </div>
        <div>
          <a class="link near-black hover-silver dib mh3 tc" href="#" title="GitHub">
